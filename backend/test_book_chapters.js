...
(async () => {
  ...
  try {
    ...
    // Navigate directly to room.examgoal.com/books/e4d8b045-a472-5039-9bec-6072e92095e8
    ...
    console.log("Book Chapters Page Preview (first 1000 chars):");
    ...
    apis.forEach((api, idx) => {
      if (api.url.includes('/api/v1/')) {
        ...
        if (api.url.includes('chapter') || api.url.includes('book') || api.url.includes('meta')) {
    ...
    // Dump page content
    fs.writeFileSync('page_book_chapters.html', await page.content());
