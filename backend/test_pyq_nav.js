...
(async () => {
  ...
  try {
    ...
    // Navigate directly to room.examgoal.com/pyq
    console.log("Navigating to room.examgoal.com/pyq...");
    apis.length = 0;
    ...
    console.log("PYQ Page Preview (first 1000 chars):");
    ...
    // Dump page content
    fs.writeFileSync('pyq_page_adv.html', await page.content());
