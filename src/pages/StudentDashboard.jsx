          ...
          <div className="glass-panel p-8 rounded-2xl border border-white/5 min-h-[60vh] space-y-6">
            {activeTab === 'courses' && (
              <div className="space-y-6 font-mono text-xs">
                <div className="flex bg-cyberdark/50 backdrop-blur-xl p-1.5 border border-white/10 rounded-xl max-w-sm mb-6 shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
                  {[
                    ...
                    <button
                      ...
                      className={`flex-1 py-2 px-4 text-xs font-bold uppercase rounded-lg transition-all duration-300 ${
                  ...
                  <div className="md:col-span-1 space-y-3 border-r border-white/5 pr-4 max-h-[70vh] overflow-y-auto custom-scrollbar">
                    ...
                    <div className="md:col-span-3">
                      {selectedSyllabusChapterId ? (
                        (() => {
                          const chapter = syllabus[selectedSyllabusClass]?.subjects?.['mathematics']?.chapters?.find(ch => ch.id === selectedSyllabusChapterId);
