      ...
      <div className="h-[52px] bg-[#2962ff] text-white flex items-center px-4 shadow-lg justify-between shrink-0 z-20">
        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          <button 
            ...
            className="hidden sm:flex items-center gap-1.5 bg-red-500/20 text-red-100 hover:bg-red-500/40 px-2 py-1 rounded text-[12px] font-semibold transition-colors"
