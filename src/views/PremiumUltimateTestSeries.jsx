...
const PremiumUltimateTestSeries = ({ user, onStartTest, onViewResult, onBack, isLight }) => {
  ...
  const theme = {
    ...
    bgNav: 'bg-surface-secondary',
    bgSidebar: 'bg-surface-secondary',
    bgContent: 'bg-surface-primary',
    bgCard: 'bg-surface-secondary',
    bgCardHover: 'hover:bg-surface-tertiary',
    bgExpanded: 'bg-surface-secondary',
    border: 'border-border-default',
    text: 'text-text-primary',
    textMuted: 'text-text-secondary',
    primary: 'text-accent-primary',
    borderPrimary: 'border-accent-primary'
  };
         ...
         <div className="flex items-center gap-3">
           ...
           <div className="flex items-center gap-2">
              <div className="flex flex-col">
                 <h1 className="text-accent-primary font-bold text-lg leading-none m-0 tracking-tight">Official Papers</h1>
                                    ...
                                    <div className="pr-4">
                                       <h3 className={`font-bold text-base sm:text-lg mb-1.5 ${isLight ? 'text-gray-800' : 'text-gray-100'} group-hover:${theme.primary} transition-colors leading-tight`}>{sectionName}</h3>
                                        <div className="flex flex-wrap gap-2 sm:gap-4 text-[10px] sm:text-xs font-semibold">
                                          {sFree > 0 && <span className="text-accent-primary flex items-center gap-1"><CheckCircle2 className="w-3 h-3 sm:w-3.5 sm:h-3.5" /> {sFree} {isUnlocked ? 'Unlocked' : 'Free'}</span>}
