...
export default function StudentDashboard({ user, courses, setActivePage, setExamTest, syllabus, initialClass = 'jee-mains',
  ...
  return (
    <>
      {/* Theme provided entirely by Global CSS and ThemeProvider now */}
      ...
      {!isTrueFullScreen && !examGoalOverviewConfig && (<div className={`study-portal-wrapper bg-surface-secondary text-text-primary px-4 md:px-12 py-10 mx-auto grid grid-cols-1 gap-8 ${isFocusMode ? 'max-w-[1600px] lg:grid-cols-1' : 'max-w-7xl lg:grid-cols-4'}`}>

        {!isFocusMode && (
      <div className="lg:col-span-1 space-y-6">
        <div className="glass-panel p-6 rounded-[var(--radius-card)] space-y-6">
          <div className="flex flex-col items-center text-center relative">
            <h3 className="text-text-primary font-bold text-lg">{user?.name}</h3>
          </div>
        </div>

        <div className="glass-panel rounded-[var(--radius-card)] flex flex-row lg:flex-col justify-around">
          {[
            ...
            { id: 'doubts', icon: LogOut, label: '24/7 Doubts' }
              ...
              <button
                ...
                className={`w-full py-4 px-5 text-xs font-bold uppercase text-left transition-colors duration-[var(--transition-fast)] ${activeTab === item.id ? 'text-accent-primary bg-accent-bg border-l-2 border-accent-primary' : 'text-text-secondary hover:text-text-primary hover:bg-surface-tertiary'}`}
              >
                {activeTab === 'courses' && (
            ...
            {activeTab === 'courses' && (
              <div className="space-y-6 font-sans text-xs">
                ...
                {!selectedSyllabusSubject && (() => {
                  ...
                  let gradientClasses = "from-cyan-300 via-cyan-400 to-blue-500";
                  let borderClasses = "border-cyan-500 border-opacity-35";
                  
                  if (selectedSyllabusClass === 'jee-mains') {
                    titleText = "JEE MAIN";
                    subText = "National Testing Agency";
                    glowColor = "rgba(6,182,212,0.4)";
                    gradientClasses = "from-cyan-300 via-cyan-400 to-blue-500";
                    borderClasses = "border-cyan-500 border-opacity-35";
                  } else if (selectedSyllabusClass === 'jee-advanced') {
                    titleText = "JEE ADVANCED";
                    subText = "Indian Institutes of Technology";
                    glowColor = "rgba(139,92,246,0.4)";
                    gradientClasses = "from-violet-400 via-purple-500 to-fuchsia-500";
                    borderClasses = "border-purple-500 border-opacity-35";
                  } else if (selectedSyllabusClass === 'nda') {
                    titleText = "NDA";
                    subText = "Union Public Service Commission";
                    glowColor = "rgba(16,185,129,0.4)";
                    gradientClasses = "from-emerald-300 via-emerald-400 to-teal-500";
                    borderClasses = "border-emerald-500 border-opacity-35";
                  } else {
                    return null;
                  }
                  ...
                  return (
                    <div className="flex justify-center py-2 mb-4">
                      <div 
                        ...
                        className={
                          "relative w-full max-w-xl px-8 py-5 rounded-2xl border flex flex-col items-center justify-center overflow-hidden transition-all " +
                          (isLight 
                            ? "bg-gradient-to-r from-blue-50 via-white to-blue-50 border-blue-200" 
                            : "bg-gradient-to-r from-[#0f1225] via-[#111625] to-[#0f1225] " + borderClasses)
                        }
                      >
                        ...
                        <h2 className={
                          "relative font-logo font-black text-3xl md:text-4.5xl tracking-widest uppercase bg-gradient-to-r " +
                          gradientClasses +
                          " bg-clip-text text-transparent leading-none drop-shadow-sm"
                        }>
                          {titleText}
                        </h2>
                        <p className={
                          "relative text-[10px] md:text-xs tracking-[0.25em] font-bold uppercase mt-1.5 font-logo " +
                          (isLight ? "text-slate-500" : "text-gray-400")
                        }>
                          {subText}
                        </p>
                        ...
                        <div className={"absolute bottom-0 left-0 w-full h-[1px] bg-gradient-to-r " + (isLight ? "from-transparent via-blue-200 to-transparent" : "from-transparent via-cyan-500 to-transparent")} />
                      </div>
                    </div>
                  );
                })()}
                ...
                <div className="flex flex-col gap-4 mb-6">
                  {/* Class Selection */}
                  <div className="flex flex-wrap bg-[#0b0c10] bg-opacity-50 backdrop-blur-xl p-1.5 border border-white border-opacity-10 rounded-xl w-fit shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
                    {[
                      { id: 'jee-mains', label: 'JEE Mains' },
                      { id: 'jee-advanced', label: 'JEE Advanced' },
                      { id: 'nda', label: 'NDA' },
                      ...
                      <button
                        ...
                        className={
                          "flex items-center justify-center flex-1 min-w-[120px] py-2 px-4 text-xs font-bold uppercase rounded-lg transition-all duration-300 " +
                          (selectedSyllabusClass === cls.id 
                            ? "bg-gradient-to-r from-blue-900 to-cyan-900 bg-opacity-30 text-cyan-300 border border-cyan-500 border-opacity-30 shadow-[0_0_15px_rgba(6,182,212,0.15)]" 
                            : "text-gray-400 hover:text-gray-200 hover:bg-white hover:bg-opacity-5 border border-transparent")
                        }
                      >
                        {getExamLogo(cls.id)}
                        {cls.label}
                      ...
                      <div className="flex flex-wrap gap-2">
                        {Object.entries(syllabus[actualClassKey]?.subjects || {}).map(([subjKey, subjVal]) => (
                          <button
                            ...
                            className={
                              "py-1.5 px-4 text-xs font-bold uppercase rounded-full border transition-all duration-300 " +
                              (selectedSyllabusSubject === subjKey
                                ? "bg-cyan-500 bg-opacity-10 border-cyan-500 border-opacity-30 text-cyan-400 shadow-[0_0_10px_rgba(6,182,212,0.1)]"
                                : "bg-white bg-opacity-5 border-white border-opacity-5 text-gray-400 hover:text-gray-200 hover:bg-white hover:bg-opacity-10")
                            }
                          >
                            {subjVal.label || subjKey}
                          </button>
                        ...
                        <button
                          ...
                          className={
                            ...
                            (selectedSyllabusSubject === 'custom_test'
                              ? "bg-amber-500 bg-opacity-10 border-amber-500 border-opacity-50 text-amber-500 shadow-[0_0_15px_rgba(245,158,11,0.2)]"
                              : "bg-gradient-to-r from-amber-500 to-orange-500 bg-opacity-20 border-amber-500 border-opacity-30 text-amber-400 hover:bg-amber-500 hover:bg-opacity-30 hover:text-amber-300")
                          }
                        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 pt-2">
                  {selectedSyllabusSubject === 'custom_test' ? (
                    ...
                    <>
                      <div className={"md:col-span-1 space-y-3 pr-4 max-h-[70vh] overflow-y-auto custom-scrollbar border-r " + (isLight ? "border-slate-200" : "border-white border-opacity-5")}>
                        <span className={"text-[10px] uppercase font-black tracking-widest block mb-4 border-b pb-2 " + (isLight ? "text-blue-600 border-slate-200" : "text-cyan-400 text-opacity-80 border-white border-opacity-10")}>Chapters List</span>
                        {(() => {
                          const actualClassKey = selectedSyllabusClass === 'jee-mains' ? 'mains' : selectedSyllabusClass === 'jee-advanced' ? 'advanced' : selectedSyllabusClass;
                          return syllabus[actualClassKey]?.subjects?.[selectedSyllabusSubject]?.chapters?.map((ch, index) => {
                            ...
                            else if (lowerTitle.includes("derivative") || lowerTitle.includes("differentiation")) icon = "dy" + String.fromCharCode(47) + "dx";
                            ...
                            return (
                              <button
                                ...
                                onClick={() => {
                                  ...
                                  const slug = (ch.url && ch.url !== '#') ? ch.url.split(String.fromCharCode(47)).pop() : (ch.id || '');
                                  let fetchSlug = String(slug || ch.id || 'unknown');
                                  if (selectedSyllabusClass === 'jee-advanced') {
                                    if (fetchSlug.startsWith('physics_')) fetchSlug = fetchSlug.replace('physics_', '');
                                    else if (fetchSlug.startsWith('chemistry_')) fetchSlug = fetchSlug.replace('chemistry_', '');
                                  ...
                                  fetch(import.meta.env.BASE_URL + "data" + String.fromCharCode(47) + "questions" + String.fromCharCode(47) + fetchSlug + ".json?_t=" + Date.now())
                                    .then(res => res.json())
                                    .then(data => {
                                      if (data && data.topics && data.questions && !Array.isArray(data.questions)) {
                                        setActivePyqData(data);
                              ...
                              >
                                ...
                                <div className={"absolute left-0 top-0 bottom-0 w-1.5 transition-all duration-300 " + (isActive ? "bg-gradient-to-b " + colorTheme : "bg-transparent group-hover:bg-white hover:bg-opacity-10")} />
                                
                                {/* Sleek icon box */}
                                <span className={
                                  "flex-shrink-0 w-9 h-9 rounded-xl flex items-center justify-center text-[13px] font-black font-mono transition-all duration-300 shadow-inner " +
                                  (isActive 
                            ...
                            return (
                              <div className="space-y-6 w-full animate-fade-in">
                                ...
                                {chapter.topics && chapter.topics.length > 0 && (
                                  <div className={"p-5 rounded-2xl shadow-xl space-y-3 mb-6 border " + (isLight ? "bg-white border-slate-200" : "bg-gradient-to-br from-[#1F2833] to-[#0B0C10] bg-opacity-80 backdrop-blur-md border-white border-opacity-10")}>
                                    <span className={"text-[10px] uppercase font-black tracking-widest flex items-center gap-2 " + (isLight ? "text-blue-600" : "text-cyan-400 text-opacity-80")}>
                                    ...
                                    <div className="flex flex-wrap gap-2.5">
                                      {chapter.topics.map(t => (
                                        <span key={t.id} className={
                                          "text-[11px] font-semibold px-3 py-1.5 rounded-lg border transition-all shadow-sm cursor-default " +
                                          (isLight 
                                            ? "text-slate-600 bg-slate-50 border-slate-200 hover:border-blue-500 hover:border-opacity-50 hover:bg-blue-50 hover:text-blue-600" 
                                            : "text-gray-200 bg-white bg-opacity-5 border-white border-opacity-10 hover:border-cyan-500 hover:border-opacity-50 hover:bg-cyan-500 hover:bg-opacity-10 hover:text-cyan-300")
                                        }>
                                          {t.title}
                                        </span>
                                      ))}
                                ...
                                <div className={"flex p-1.5 border rounded-xl justify-between gap-2 overflow-x-auto " + (isLight ? "bg-white border-slate-200 shadow-sm" : "bg-[#0b0c10] bg-opacity-50 border-white border-opacity-10 shadow-[0_4px_20px_rgba(0,0,0,0.5)]")}>
                                  {[
                                    { id: 'videos', label: 'Lectures', icon: '🎥' },
                                    { id: 'pdfs', label: 'Notes/DPPs', icon: '📄' },
                                    { id: 'formulas', label: 'Formulas', icon: '⚡' },
                                    ...
                                    return (
                                      <button
                                        ...
                                        onClick={() => setChapterTab(subTab.id)}
                                        className={
                                          "relative flex-1 flex flex-col sm:flex-row items-center justify-center gap-1.5 py-2.5 px-3 rounded-lg transition-all duration-300 uppercase whitespace-nowrap overflow-hidden group border " +
                                          (isActive 
                                            ? (isLight 
                                                ? "bg-blue-50 border-blue-200 text-blue-600 shadow-[0_4px_12px_rgba(37,99,235,0.08)] font-bold" 
                                                : "bg-gradient-to-r from-blue-600 to-cyan-500 bg-opacity-20 border-cyan-400 border-opacity-30 text-cyan-300 shadow-[0_0_15px_rgba(6,182,212,0.15)] font-bold") 
                                            : (isLight 
                                                ? "hover:bg-slate-50 border-transparent text-slate-500 hover:text-slate-700" 
                                                : "hover:bg-white hover:bg-opacity-5 border-transparent text-gray-400 hover:text-gray-200"))
                                        }
                                      >
                                        {isActive && (
                                          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-cyan-400 bg-opacity-10 to-transparent -translate-x-full group-hover:animate-sweep" />
                                        )}
                                ...
                                <div className={"relative p-6 border rounded-2xl min-h-[35vh] overflow-hidden " + (isLight ? "bg-white border-slate-200 shadow-sm" : "bg-gradient-to-b from-[#1F2833] to-[#0B0C10] bg-opacity-40 backdrop-blur-md border-white border-opacity-10 shadow-[0_8px_32px_rgba(0,0,0,0.4)]")}>
                                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-[120px] bg-cyan-500 bg-opacity-5 blur-[80px] pointer-events-none rounded-full" />
                                    ...
                                    <div className="space-y-2">
                                      {(!chapter.videos || chapter.videos.length === 0) ? (
                                        ...
                                        chapter.videos.map(v => {
                                          const unlocked = isResourceUnlocked(v);
                                          return (
                                            <div key={v.id} className={"flex justify-between items-center p-3 rounded-lg border " + (isLight ? "bg-slate-50 border-slate-200" : "bg-[#0b0c10] bg-opacity-60 border-white border-opacity-5")}>
                                              <div>
                                                <div className="flex items-center gap-1.5">
                                                  <h5 className={`font-semibold text-xs ${isLight ? 'text-slate-800' : 'text-white'}`}>{v.title}</h5>
                                                  {v.isFree && <span className="text-[8px] bg-emerald-500 bg-opacity-10 border border-emerald-500 border-opacity-20 px-1.5 py-0.2 rounded font-bold">DEMO</span>}
                                                  {!unlocked && <span className="text-[8px] bg-red-500 bg-opacity-10 border border-red-500 border-opacity-20 px-1.5 py-0.2 rounded font-bold">LOCKED</span>}
                                                </div>
                                              ...
                                              <button
                                                ...
                                                className={
                                                  "px-3.5 py-1.5 font-bold text-[9px] uppercase rounded-lg flex items-center gap-1.5 transition-colors " +
                                                  (unlocked 
                                                    ? "bg-electric hover:bg-cyan-400 text-obsidian shadow-md hover:shadow-cyan-500 hover:shadow-opacity-10" 
                                                    : "bg-[#450a0a] bg-opacity-20 border border-red-900 text-red-400 cursor-not-allowed")
                                                }
                                              >
                                        ...
                                        chapter.pdfs.map(p => {
                                          ...
                                          return (
                                            <div key={p.id} className="space-y-2">
                                              <div className={"flex justify-between items-center p-3 rounded-lg border " + (isLight ? "bg-slate-50 border-slate-200" : "bg-[#0b0c10] bg-opacity-60 border-white border-opacity-5")}>
                                                <div>
                                                  <div className="flex items-center gap-1.5">
                                                    <h5 className={`font-semibold text-xs ${isLight ? 'text-slate-800' : 'text-white'}`}>{p.title}</h5>
                                                    {p.isFree && <span className="text-[8px] bg-emerald-500 bg-opacity-10 border border-emerald-500 border-opacity-20 px-1.5 py-0.2 rounded font-bold">FREE</span>}
                                                    {!unlocked && <span className="text-[8px] bg-red-500 bg-opacity-10 border border-red-500 border-opacity-20 px-1.5 py-0.2 rounded font-bold">LOCKED</span>}
                                                  </div>
                                                ...
                                                <button
                                                  ...
                                                  className={
                                                    "px-3.5 py-1.5 font-bold text-[9px] uppercase rounded-lg flex items-center gap-1.5 transition-colors " +
                                                    (unlocked 
                                                      ? "bg-blue-600 bg-opacity-20 border border-blue-500 text-white"
                                                      : "bg-[#450a0a] bg-opacity-20 border border-red-900 text-red-400 cursor-not-allowed")
                                                  }
                                                >
                                    ...
                                    <div className="grid grid-cols-1 gap-3">
                                      {(!chapter.formulas || chapter.formulas.length === 0) ? (
                                        ...
                                        chapter.formulas.map(f => {
                                           return (
                                             <div key={f.id} className={"p-4 rounded-xl space-y-2 border " + (isLight ? "bg-slate-50 border-slate-200" : "bg-[#0b0c10] bg-opacity-40 border-white border-opacity-5")}>
                                               <h5 className={"font-bold text-xs border-b pb-1 flex items-center justify-between gap-1.5 " + (isLight ? "text-blue-600 border-slate-200" : "text-gold border-white border-opacity-5")}>
                                                 <span className="flex items-center gap-1.5">
                                                 ...
                                                 {f.url && (
                                                   <button
                                                     onClick={() => setSelectedPdf({ id: "formula-" + f.id, url: f.url, title: f.title })}
                                                     className={"px-2.5 py-1 text-[9px] font-bold uppercase rounded-lg flex items-center gap-1 " + (isLight ? "bg-blue-50 text-blue-600 border border-blue-200 hover:bg-blue-100" : "bg-electric bg-opacity-10 text-electric border border-electric border-opacity-20 hover:bg-electric hover:bg-opacity-20")}
                                                   >
                                                     📄 View File
                                                   </button>
                                                 )}
                                  ...
                                  {/* 4. PYQs Tab */}
                                  {chapterTab === 'pyqs' && (() => {
                                      const slug = (chapter.url && chapter.url !== '#') ? chapter.url.split(String.fromCharCode(47)).pop() : (chapter.id || '');
                                    ...
                                    return (
                                      <div className="space-y-4">
                                         <div 
                                          ...
                                          className={"border-l-4 border-electric rounded-lg p-4 flex items-center justify-between cursor-pointer hover:shadow-lg transition-all border " + (isLight ? "bg-white border-slate-200 shadow-sm" : "bg-[#1e1e24] border-white border-opacity-5 shadow-md")}
                                         >
                                           ...
                                           <div className="flex items-center gap-3">
                                             <span className={"px-3 py-1 rounded-md text-xs font-bold " + (isLight ? "bg-slate-100 text-slate-600" : "bg-white bg-opacity-5 text-gray-300")}>{qCount} Questions</span>
                                         ...
                                         <div 
                                              ...
                                              className={"border-l-4 border-yellow-400 rounded-lg p-4 flex items-center justify-between cursor-pointer hover:shadow-lg transition-all border " + (isLight ? "bg-white border-slate-200 shadow-sm" : "bg-[#1e1e24] border-white border-opacity-5 shadow-md")}
                                           >
                                             <div className="flex items-center gap-4">
                                    ...
                                    <div className="space-y-2">
                                      {(!chapter.mockTests || chapter.mockTests.length === 0) ? (
                                        ...
                                        chapter.mockTests.map(t => (
                                          <div key={t.id} className={"p-4 rounded-xl flex flex-col md:flex-row md:items-center justify-between gap-4 border " + (isLight ? "bg-slate-50 border-slate-200" : "bg-[#0b0c10] bg-opacity-60 border-white border-opacity-5")}>
                                            <div className="space-y-1">
                                            ...
                                            {t.type === 'link' ? (
                                              ...
                                              <button
                                                ...
                                                className="px-4 py-2 bg-electric hover:bg-cyan-400 text-obsidian font-bold text-[9px] uppercase rounded-lg shadow-md hover:shadow-cyan-500 hover:shadow-opacity-10 transition-colors"
                                              >
                                                Start JEE Mock Exam
                                              </button>
                                            )}
