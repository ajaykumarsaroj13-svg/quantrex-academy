import{r as i,j as t}from"./index-Bm3-kkvO.js";function p({html:r,isLight:n=!0,correctOptionLabel:o}){const a=i.useMemo(()=>{if(!r)return'<p style="color:#999;font-style:italic;font-family:sans-serif;font-size:14px;">Solution coming soon — stay tuned! 📝</p>';let e=r.toString();return e=e.replace(/style\s*=\s*"[^"]*"/gi,""),e=e.replace(/style\s*=\s*'[^']*'/gi,""),e=e.replace(/\\root\s+([a-zA-Z0-9]+)\s+\\of\s+\{([^}]+)\}/g,"\\sqrt[$1]{$2}"),e=e.replace(/\\root\s+([a-zA-Z0-9]+)\s+\\of\s+([a-zA-Z0-9]+)/g,"\\sqrt[$1]{$2}"),e=e.replace(/\\Rightarrow([a-zA-Z]+)/g,"\\Rightarrow \\text{$1}"),e},[r]);return i.useEffect(()=>{window.MathJax&&window.MathJax.typesetPromise&&window.MathJax.typesetPromise().catch(e=>console.log("MathJax error in TeacherSolution:",e))},[a]),t.jsxs("div",{className:"teacher-solution-wrapper",children:[t.jsx("style",{children:`
      ...
      `}),t.jsx("svg",{width:"0",height:"0",style:{position:"absolute",pointerEvents:"none"},children:t.jsx("filter",{id:"watermark-threshold",children:t.jsxs("feComponentTransfer",{children:[t.jsx("feFuncR",{type:"linear",slope:"4",intercept:"-2"}),t.jsx("feFuncG",{type:"linear",slope:"4",intercept:"-2"}),t.jsx("feFuncB",{type:"linear",slope:"4",intercept:"-2"})]})})}),o&&t.jsxs("div",{className:"sol-correct-option",children:[t.jsx("span",{children:"✅"}),t.jsxs("span",{children:["Correct Answer: ",o]})]}),t.jsx("div",{className:"tex2jax_process",dangerouslySetInnerHTML:{__html:a}})]})}export{p as T};
