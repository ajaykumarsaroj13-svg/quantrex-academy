      ...
      <div className="nta-main-content">
        ...
        <div className="nta-question-panel">
          ...
          <div className="nta-question-text">
            ...
            <span className="nta-q-content" dangerouslySetInnerHTML={{ __html: question?.questionText || 'Loading...' }} />
          </div>
            ...
            <div className="nta-options">
              {(question?.options || []).map((opt, idx) => (
                ...
                >
                  ...
                  <span className="nta-option-text" dangerouslySetInnerHTML={{ __html: opt }} />
                </div>
              ))}
            </div>
          )}
