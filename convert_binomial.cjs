...
const metaKey = 'https://room.examgoal.com/api/v1/past-question/question/meta/6b83327c-6da3-51f7-8845-5192226d0d87';
...
fs.writeFileSync('public/data/questions/binomial-theorem.json', JSON.stringify(formattedQuestions, null, 2));
console.log(`Successfully converted ${formattedQuestions.length} questions and saved to binomial-theorem.json`);
