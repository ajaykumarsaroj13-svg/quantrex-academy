...
(async () => {
  ...
  console.log('Clicking JEE Main card...');
  ...
  console.log('URL after clicking JEE Main card:', currentUrl);

  const pageHtml = await page.content();
  fs.writeFileSync('after_card.html', pageHtml);
  await page.screenshot({ path: 'after_card.png' });
